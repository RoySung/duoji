# report-member-filter Specification

## Purpose

TBD - created by archiving change 'add-report-member-filter'. Update Purpose after archive.
...
<!-- @trace
source: add-report-member-filter
updated: 2026-06-14
code:
