...
const SUB_STEPS: OnboardingSubStep[] = [
  {
    ...
    titleKey: 'onboarding.step7.sub1.title',
    descriptionKey: 'onboarding.step7.sub1.description',
    showNextButton: false,
  },
  {
    selector: '[data-onboarding-anchor="transaction-form-amount"]',
    titleKey: 'onboarding.step7.sub2.title',
    descriptionKey: 'onboarding.step7.sub2.description',
    showNextButton: true,
  },
  {
    selector: '[data-onboarding-anchor="transaction-form-category"]',
    titleKey: 'onboarding.step7.sub3.title',
    descriptionKey: 'onboarding.step7.sub3.description',
    showNextButton: true,
  },
  {
    selector: '[data-onboarding-anchor="transaction-form-payer"]',
    titleKey: 'onboarding.step7.sub4.title',
    descriptionKey: 'onboarding.step7.sub4.description',
    showNextButton: true,
  },
  {
    selector: '[data-onboarding-anchor="transaction-form-split"]',
    titleKey: 'onboarding.step7.sub5.title',
    descriptionKey: 'onboarding.step7.sub5.description',
    showNextButton: true,
  },
  {
    selector: '[data-onboarding-anchor="transaction-form-submit"]',
    titleKey: 'onboarding.step7.sub6.title',
    descriptionKey: 'onboarding.step7.sub6.description',
    showNextButton: false,
  },
]
